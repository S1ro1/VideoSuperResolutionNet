...
def parse_args():
    ...
    parser.add_argument("--logger-type", type=str, default="wandb", help="Logger type (wandb, tensorboard)")

    parser.add_argument("--train-hq", type=str, required=True, help="Path to the high quality training dataset")
    parser.add_argument("--train-lq", type=str, required=True, help="Path to the low quality training dataset")
    parser.add_argument("--val-hq", type=str, required=True, help="Path to the high quality validation dataset")
    parser.add_argument("--val-lq", type=str, required=True, help="Path to the low quality validation dataset")
    parser.add_argument("--batch-size", type=int, default=4, help="Batch size")
    parser.add_argument("--num-workers", type=int, default=6, help="Number of workers for the dataloader")

    parser.add_argument("--devices", type=int, nargs="+", default=[0], help="Devices to use for training")

    parser.add_argument("--epochs", type=int, default=100, help="Number of epochs to train")
    parser.add_argument("--log-every-n-steps", type=int, default=50, help="Log every n steps")
    parser.add_argument("--check-val-every-n-epoch", type=int, default=5, help="Check validation every n epochs")
    parser.add_argument("--save-top-k", type=int, default=3, help="Save top k models")

    parser.add_argument("--learnging-rate", type=float, default=2e-3, help="Learning rate")
